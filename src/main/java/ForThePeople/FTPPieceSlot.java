...
//BR// displays the pieces 66% reduced, for better packing
 ...
 */
public class FTPPieceSlot extends VASSAL.build.widget.PieceSlot implements MouseListener, KeyListener {
  ...
  public FTPPieceSlot() {
    panel = new FTPPieceSlot.Panel(this);
    panel.addMouseListener(this);
    panel.addKeyListener(this);
  }

  public FTPPieceSlot(FTPPieceSlot piece) {
    this();
    copyFrom(piece);
  }

  protected void copyFrom(FTPPieceSlot piece) {
    c = piece.c;
    name = piece.name;
  ...
  public class Panel extends JPanel {
    ...
    protected FTPPieceSlot pieceSlot;

    public Panel(FTPPieceSlot slot) {
      super();
      setFocusTraversalKeysEnabled(false);
      pieceSlot = slot;
    }

    public FTPPieceSlot getPieceSlot() {
      return pieceSlot;
    }

    public void paint(Graphics g) {
      FTPPieceSlot.this.paint(g);
    }

    public Dimension getPreferredSize() {
      return FTPPieceSlot.this.getPreferredSize();
    }
  }

  public FTPPieceSlot(GamePiece p) {
    this();
    setPiece(p);
  }
  ...
  public void paint(Graphics g) {
    ...
    if (getExpandedPiece() == null) {
      ...
      getExpandedPiece().draw(g, size.width / 2, size.height / 2, panel, 0.66666); //BR//   .6666
      ...
      if (Boolean.TRUE.equals(getPiece().getProperty(Properties.SELECTED))) {
        BasicPiece.getHighlighter().draw(getExpandedPiece(), g,
          size.width / 2, size.height / 2, panel, 0.666666);  //BR// 0.666666
      }
    }
  }
...
//      c.draw(panel.getGraphics(), 0, 0, panel, 1.0);
      ...
      bound.width = bound.width * 2 / 3;                    //BR// 2/3
      bound.height = bound.height * 2 / 3;
      return bound;
    }
    else {
  ...
  private static class MyConfigurer extends Configurer implements HelpWindowExtension {
    ...
    public MyConfigurer(FTPPieceSlot slot) {
    ...
    public Object getValue() {
      FTPPieceSlot slot = (FTPPieceSlot) super.getValue();
      if (slot != null) {
