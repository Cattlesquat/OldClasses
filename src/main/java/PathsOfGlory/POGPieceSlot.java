 ...
 */
public class POGPieceSlot extends VASSAL.build.widget.PieceSlot implements MouseListener, KeyListener {
  ...
  public POGPieceSlot() {
    panel = new POGPieceSlot.Panel(this);
    panel.addMouseListener(this);
    panel.addKeyListener(this);
  }

  public POGPieceSlot(POGPieceSlot piece) {
    this();
    copyFrom(piece);
  }

  protected void copyFrom(POGPieceSlot piece) {
    c = piece.c;
    name = piece.name;
  ...
  public class Panel extends JPanel {
    ...
    protected POGPieceSlot pieceSlot;

    public Panel(POGPieceSlot slot) {
      super();
      setFocusTraversalKeysEnabled(false);
      pieceSlot = slot;
    }

    public POGPieceSlot getPieceSlot() {
      return pieceSlot;
    }

    public void paint(Graphics g) {
      POGPieceSlot.this.paint(g);
    }

    public Dimension getPreferredSize() {
      return POGPieceSlot.this.getPreferredSize();
    }
  }

  public POGPieceSlot(GamePiece p) {
    this();
    setPiece(p);
  }
  ...
  public void paint(Graphics g) {
    ...
    if (getExpandedPiece() == null) {
      ...
      getExpandedPiece().draw(g, size.width / 2, size.height / 2, panel, 0.6666); //BR//
      ...
      if (Boolean.TRUE.equals(getPiece().getProperty(Properties.SELECTED))) {
        BasicPiece.getHighlighter().draw(getExpandedPiece(), g,
          size.width / 2, size.height / 2, panel, 0.666666);  //BR//
      }
    }
  }
...
//      c.draw(panel.getGraphics(), 0, 0, panel, 1.0);
  ...
  private static class MyConfigurer extends Configurer implements HelpWindowExtension {
    ...
    public MyConfigurer(POGPieceSlot slot) {
    ...
    public Object getValue() {
      POGPieceSlot slot = (POGPieceSlot) super.getValue();
      if (slot != null) {
