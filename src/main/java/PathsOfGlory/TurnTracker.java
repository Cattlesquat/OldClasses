...
public class TurnTracker extends TurnComponent implements CommandEncoder, GameComponent, ActionListener, UniqueIdManager.Identifyable {
  ...
  protected static UniqueIdManager idMgr = new UniqueIdManager("POGTurnTracker"); //$NON-NLS-1$
  ...
  protected static final String FONT_SIZE = "POGturnFontSize"; //$NON-NLS-1$
  protected static final String FONT_BOLD = "POGturnFontBold"; //$NON-NLS-1$
  protected static final String DOCKED = "POGturnDocked"; //$NON-NLS-1$
  protected static final String PADDING = "POGturnPadding"; //$NON-NLS-1$
  ...
  public TurnTracker() {
    ...
    final IntConfigurer padding = new IntConfigurer(PADDING, "Turn Extra Padding (requires restart): ", 40); //$NON-NLS-1$
