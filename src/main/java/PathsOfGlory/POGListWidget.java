...
//BR// Try to make the list not grab as much vertical space
 ...
 * component */
public class POGListWidget extends VASSAL.build.widget.ListWidget
  ...
  public Component getComponent() {
    if (panel == null) {
      ...
      if (width > 0 && height > 0) {
        split.setPreferredSize(new Dimension(width,height*2/3)); //BR//
        split.revalidate(); //BR//
      }
      if (divider > 0){
