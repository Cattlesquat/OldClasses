...
public class POGChatter extends VASSAL.build.module.Chatter implements CommandEncoder, Buildable {
	...
	protected JScrollPane scroll2 = new ScrollPane(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
			JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
	protected static final String MY_CHAT_COLOR    = "POGChatColor";          //$NON-NLS-1$ //BR// Different tags to "restart" w/ new default scheme
	protected static final String OTHER_CHAT_COLOR = "POGotherChatColor";     //$NON-NLS-1$
	protected static final String GAME_MSG1_COLOR  = "POGgameMessage1Color";  //$NON-NLS-1$
	protected static final String GAME_MSG2_COLOR  = "POGgameMessage2Color";  //$NON-NLS-1$ //BR//
	protected static final String GAME_MSG3_COLOR  = "POGgameMessage3Color";  //$NON-NLS-1$ //BR//
	protected static final String GAME_MSG4_COLOR  = "POGgameMessage4Color";  //$NON-NLS-1$ //BR//
	protected static final String GAME_MSG5_COLOR  = "POGgameMessage5Color";  //$NON-NLS-1$ //BR//
	protected static final String SYS_MSG_COLOR    = "POGsystemMessageColor"; //$NON-NLS-1$
	...
	public void show(String s) {
		...
		if (s.length() > 0) {
			if (s.startsWith("*")) {
				...
				//BR// If I'm Central Powers, them I'm grey and everybody else is blue. Otherwise I'm blue and everybody else is grey.
	...
	public void addTo(Buildable b) {
		...
		//BR//
		//BR// game message color #5 (messages starting with "`")
		//BR//
		...
		Resources.getString("AP Chat Color:  "), new Color(9, 32, 229) );
		...
		Resources.getString("CP Chat Color:  "), new Color (75, 75, 75) );
	...
	public static class DisplayText extends Command {
		private String msg;
		private POGChatter c;

		public DisplayText(POGChatter c, String s) {
			this.c = c;
			msg = s;
			if (msg.startsWith("<>")) {
				msg = "&lt;(" + POGChatter.getAnonymousUserName() + ")&gt;" + s.substring(2); // BR// HTML-friendly
																								// angle brackets
			} else {
				msg = s;
			}
	...
	public static void main(String[] args) {
		POGChatter chat = new POGChatter();
		JFrame f = new JFrame();
		f.add(chat);
		f.pack();
		f.setVisible(true);
