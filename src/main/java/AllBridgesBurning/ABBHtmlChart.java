...
//BR// Overridden only for the purpose of making it scroll faster. Unfortunately I had to override the entire class because the key components were defined as private & inaccessible.
 ...
 * of its own
 */
public class ABBHtmlChart extends VASSAL.build.widget.HtmlChart implements MouseListener {
  ...
  public Component getComponent() {
    if (htmlWin == null) {
      ...
      scroller.getVerticalScrollBar().setUnitIncrement(40); //BR// Literally the only change I made in this file -- just can't stand how slow it scrolls
    }
    return scroller;
  }
